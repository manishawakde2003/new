...
$sql=pg_query($con,"insert into tblnotes(noteCategory,noteTitle,noteDescription,createdBy) values('$category','$ntitle','$ndescription','$createdby')");
...
$query=pg_query($con,"select * from tblcategory where createdBy='$userid'");
